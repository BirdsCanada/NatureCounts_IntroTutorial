...
# Print the metadata of the collection(s) with the specified project_id
if (nrow(collection_metadata) > 0) {
 # Iterate over each row and print its contents
  for (i in 1:nrow(collection_metadata)) {
    print(collection_metadata[i, ])
  }
} else {
