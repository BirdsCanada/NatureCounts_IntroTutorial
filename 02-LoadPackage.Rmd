...
## 2.1 Installing the NatureCounts package {#Package2.1}
...
## 2.2 Installing additional packages {#Package2.2}
...
Congratulations! You have installed the NatureCounts R package. In the next chapter we will develop a better understand of the data structure, access levels, and authorizations before learning to download data.
