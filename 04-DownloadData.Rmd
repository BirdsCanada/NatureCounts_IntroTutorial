...
```{r nc_dl_Filter, eval = FALSE, eval = FALSE}
...
[Here](https://www.birdscanada.org/monitoring/georef_rec.jsp?lang=EN) is a handy tools to help you get the coordiantes of a bounding box for your study region.  
