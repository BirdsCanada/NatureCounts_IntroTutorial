...
Through the naturecounts R package, data is downloaded with a specific set of fields/columns by default. However, for more advanced applications, users may wish to [specify which fields/columns to return](https://birdscanada.github.io/naturecounts/articles/selecting-fields.html).
